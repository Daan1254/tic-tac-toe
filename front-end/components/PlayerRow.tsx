...
import {Player} from "@/pages/[uuid]";

export default function PlayerRow({name, id, rating}: Player) {
    function kickPlayer() {
        ...
        <div className="flex justify-between items-center h-16 p-4 my-6  rounded-lg border border-gray-100 shadow-md">
            <div className="flex items-center">
                ...
                <div className="ml-2">
                    ...
                    <div className="text-sm font-light text-gray-500">Level {rating} - Diamond III</div>
                </div>
            </div>
            <div>
                <button onClick={kickPlayer} className="bg-red-400 hover:bg-red-500 p-2 rounded-full shadow-md flex justify-center items-center">
